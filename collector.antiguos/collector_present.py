...
parser = argparse.ArgumentParser(description='Collector datalab 0XBEBACAFE')
parser.add_argument(
...
print(db_connection, kairos_server, es_server, index, doc_type)
...
collector_datalab_present(db_connection,kairos_server,data_filter,data_parser,es_object,index,doc_type,es_generator_data)
